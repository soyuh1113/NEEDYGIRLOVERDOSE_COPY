...
public class WindowSize : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IDragHandler
{
    ...
    {
        windowMove.cursorLockMode = Cursor.lockState;
        Cursor.lockState = CursorLockMode.Confined;
        
        windowMove.originPos = windowMove.uiTarget.position;
        windowMove.originMousePos = eventData.position;
        
        windowMove.uiTarget.SetAsLastSibling();
        windowMove.UpdateChildImages();
    }
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        RectTransform uiRectTransform = windowMove.uiTarget.GetComponent<RectTransform>();
        RectTransform parentRectTransform = windowMove.uiTarget.parent.GetComponent<RectTransform>();
        
        Vector2 dragAmount = eventData.position - windowMove.originMousePos;
